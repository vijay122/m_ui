    ...
    (
      <div>
            ...
            <div className="container">
              ...
              <div className="search-box">
                <div id="sb-search" className="sb-search">
                  <form>
                    <input className="sb-search-input" placeholder="Enter your search term..." type="search"
        ...
        <div className="content">
              ...
              <div className="shipping-section-grid">
                <div className="col-md-7 shipping-left-grid">
                  ...
                  <div className="icon-text">
                    <p>Lorem ipsum is dolor sit suspendise amet latest videos of lorem feworem ipsum is dolor sit sud
                      spendi desig sunpoen controey feworem ipsum is dolor sit suspendi desig.</p>
                  </div>
                  <div className="clearfix"></div>
                </div>
                <div className="col-md-5 shipping-right-grid">
                  ...
                  <div className="news-search-box">
                    <form>
                      <input type="text" className="text" value="" onfocus="this.value = '';"
          ...
          <div className="map">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d396369.7968760607!2d-94.5757195!3d39.091919000000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87c0f75eafe99997%3A0x558525e66aaa51a2!2sKansas+City%2C+MO%2C+USA!5e0!3m2!1sen!2sin!4v1416895090472"
