...
// Initialize google maps
  initializeMap() {
    ...
    new this.getMyLocation(myLocationDiv, map);
  ...
  getMyLocation(myLocationDiv, map) {
...
// Create listeners
  ...
  render() {
    const styles = require('./TravelMap.scss');
    return (
      <div>
        <div id="map-canvas" className={styles.mapLayout}></div>
        <div className="hr vpad"></div>
        <div>
          <table>
            <thead>
            </thead>
            ...
            <tr id="ga-buttons">
              <td colSpan="2">
                <button id="find-route">Start</button>
                <button id="clear-map">Clear</button>
              </td>
            </tr>
            </tbody>
          </table>
