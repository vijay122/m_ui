    ...
    return (
      ...
      >
        ...
        <List>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('packages')}>
            <View style={styles.listItemContainer}>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('hotels')}>
            <View style={styles.listItemContainer}>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('places')}>
            <View style={styles.listItemContainer}>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('inputgroup')}>
            <View style={styles.listItemContainer}>
              ...
              <Text style={styles.text}>Upload Place</Text>
            </View>
          </ListItem>
          <ListItem button iconLeft onPress={() => this.navigateTo('layout')}>
            <View style={styles.listItemContainer}>
              ...
              <Text style={styles.text}>Upload Package</Text>
            </View>
          </ListItem>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('picker')}>
            <View style={styles.listItemContainer}>
              ...
              <Text style={styles.text}>Manage Places</Text>
            </View>
          </ListItem>
          <ListItem button iconLeft onPress={() => this.navigateTo('radio')}>
            <View style={styles.listItemContainer}>
              ...
              <Text style={styles.text}>Manage Packages</Text>
            </View>
          </ListItem>
